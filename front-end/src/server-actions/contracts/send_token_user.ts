...
export async function sendTokensToUserAvalanche(_args: BuyTokenArgs) {
    console.log("Avalanche support has been removed. Use Bitfinity EVM tokens instead.");
    throw new MyError("Avalanche support has been removed. Use sendTokensToUserBitfinity instead.");
}

// Legacy Hedera function - deprecated
// eslint-disable-next-line @typescript-eslint/no-unused-vars
export async function sendTokensToUserHedera(_args: { tokenId: string, amount: number, receiverAddress: string }) {
    console.log("Hedera support has been removed. Use Bitfinity EVM tokens instead.");
    throw new MyError("Hedera support has been removed. Use sendTokensToUserBitfinity instead.");
}
