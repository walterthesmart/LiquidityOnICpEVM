 ...
 */
const TradingViewCompanyProfileWidget: React.FC<TradingViewCompanyProfileWidgetProps> = memo(
  ({
    symbol,
    width = "100%",
    height = 550,
    ...
    }, [symbol, tradingViewSymbol, width, height, theme, isTransparent, containerId]);
