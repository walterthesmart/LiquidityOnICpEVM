 ...
 */
const TradingViewTechnicalAnalysisWidget: React.FC<TradingViewTechnicalAnalysisWidgetProps> = memo(
  ({
    symbol,
    width = "100%",
    height = 450,
      ...
      const timeoutId = setTimeout(() => {
        try {
          ...
          const widgetConfig: TradingViewTechnicalAnalysisConfig = {
            ...
            height: typeof height === "number" ? height : parseInt(height as string) || 450,
            locale: "en",
            colorTheme: theme,
    ...
    }, [symbol, tradingViewSymbol, width, height, theme, isTransparent, showIntervalTabs, interval, displayMode, containerId]);
...
TradingViewTechnicalAnalysisWidget.displayName = "TradingViewTechnicalAnalysisWidget";
