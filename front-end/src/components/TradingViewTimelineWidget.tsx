 ...
 */
const TradingViewTimelineWidget: React.FC<TradingViewTimelineWidgetProps> = memo(
  ({
    symbol,
    market = "nigeria",
    feedMode = "market",
      ...
      const timeoutId = setTimeout(() => {
        try {
          ...
          const widgetConfig: TradingViewTimelineConfig = {
            ...
            height: typeof height === "number" ? height : parseInt(height as string) || 550,
            locale: "en",
            colorTheme: theme,
    ...
    }, [symbol, tradingViewSymbol, market, feedMode, width, height, theme, isTransparent, displayMode, containerId]);
