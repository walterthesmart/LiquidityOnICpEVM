          ...
          <div className="text-center py-12">
            <div className="max-w-md mx-auto">
              ...
              <p className="text-gray-600 mb-6">
                Connect your wallet to start trading Nigerian stocks with NGN stablecoin
              </p>
              <div className="bg-blue-600 text-white px-6 py-3 rounded-lg hover:bg-blue-700 transition-colors inline-block">
                Connect Wallet
              </div>
            </div>
          </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  <div className="bg-white rounded-lg shadow-md p-6">
                    <div className="flex items-center">
                      ...
                      <div className="ml-4">
                        ...
                        <p className="text-gray-600">Real-time trading data</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="bg-white rounded-lg shadow-md p-6">
                    <div className="flex items-center">
                      ...
                      <div className="ml-4">
                        <h3 className="text-lg font-semibold text-gray-900">Fast Swaps</h3>
                        <p className="text-gray-600">Instant token exchanges</p>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            {activeTab === 'trade' && (
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="space-y-6">
                  ...
                  {/* Trading Tips */}
                  <div className="bg-white rounded-lg shadow-md p-6">
                    <h4 className="text-lg font-semibold text-gray-900 mb-4">Trading Tips</h4>
                    <div className="space-y-3">
                      <div className="flex items-start space-x-3">
                        ...
                        <p className="text-sm text-gray-600">
                          Check price impact before large trades to avoid slippage
                        </p>
                      </div>
                      <div className="flex items-start space-x-3">
            ...
            {activeTab === 'wallet' && (
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div className="space-y-6">
                    ...
                    <div className="space-y-3">
                      <div className="flex items-center justify-between py-3 border-b border-gray-100">
                        <div className="flex items-center space-x-3">
                          ...
                          <div>
                            <p className="text-sm font-medium text-gray-900">Sent NGN</p>
                            <p className="text-xs text-gray-500">2 hours ago</p>
                          </div>
                        </div>
                        <span className="text-sm font-medium text-red-600">-₦1,000.00</span>
                      </div>
                      ...
                      <div className="flex items-center justify-between py-3 border-b border-gray-100">
                        <div className="flex items-center space-x-3">
                          ...
                          <div>
                            <p className="text-sm font-medium text-gray-900">Swapped DANGCEM</p>
                      ...
                      <div className="flex items-center justify-between py-3">
                        <div className="flex items-center space-x-3">
                          ...
                          <div>
                            <p className="text-sm font-medium text-gray-900">Received NGN</p>
                  ...
                  {/* NGN Info */}
                  <div className="bg-white rounded-lg shadow-md p-6">
                    <h4 className="text-lg font-semibold text-gray-900 mb-4">About NGN Stablecoin</h4>
                    <div className="space-y-3 text-sm text-gray-600">
                      <p>
                        NGN is a stablecoin pegged to the Nigerian Naira, designed for seamless 
                        trading of tokenized Nigerian stocks.
                      </p>
      ...
      <footer className="bg-white border-t mt-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="text-center text-gray-600">
            <p>© 2024 Nigerian Stock Exchange DEX. Built with security and transparency in mind.</p>
